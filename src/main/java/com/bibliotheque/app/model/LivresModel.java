...
public class LivresModel {
    ...
    public LivresModel(int id, String titre) {
    this.id = id;
    this.titre = titre;
}


    public LivresModel(int id, String titre, String auteur, String theme, LocalDate datePublication, int nombreExemplaires, boolean disponible) {
        this.id = id;
        this.titre = titre;
        this.auteur = auteur;
        this.theme = theme;
